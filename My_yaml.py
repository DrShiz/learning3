...
def easy_lvl_const(loader, node):
...
def medium_lvl_const(loader, node):
    data = loader.construct_mapping(node)
...
def hard_lvl_const(loader, node):
    data = loader.construct_mapping(node)
    _map = HardLevel.Map()
...
loader = yaml.Loader
loader.add_constructor('!easy_level', easy_lvl_const)
loader.add_constructor('!medium_level', medium_lvl_const)
loader.add_constructor('!hard_level', hard_lvl_const)

...
class GameSurface(ScreenHandle):
    ...
    def draw_map(self):
        min_x = 0
        min_y = 0
        min_x, min_y = self.calc(min_x, min_y)
...
class ProgressBar(ScreenHandle):
    ...
    def draw(self, canvas):
        ...
        pygame.draw.rect(self, colors["green"], (50, 70,
                                                 200 * self.engine.hero.xp / (100 * (2**(self.engine.hero.level - 1))), 30))
        ...
        self.blit(font.render(f'{self.engine.hero.hp}/{self.engine.hero.max_hp}', True, colors["black"]),
                  (60, 30))
        self.blit(font.render(f'{self.engine.hero.xp}/{(100*(2**(self.engine.hero.level-1)))}', True, colors["black"]),
                  (60, 70))
